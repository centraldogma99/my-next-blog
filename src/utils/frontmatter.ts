...
export function generateFrontmatter(formData: FormData): string {
  ...
  const frontmatterObj: Partial<Frontmatter> & { title: string; date: string; slug?: string } = {
    title,
...
export function generateFrontmatterString(frontmatter: Partial<Frontmatter> & { title: string; date: string; slug?: string }): string {
  ...
  if (frontmatter.subtitle) {
    frontmatterStr += `subtitle: "${frontmatter.subtitle}"\n`;
  }
